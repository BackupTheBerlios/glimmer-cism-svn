...
#     Calculate statistics of the other model results
      if sum(count) == 0:
        print 'To compare with other models you need to download the ISMIP-HOM results from: http://homepages.ulb.ac.be/~fpattyn/ismip/tc-2-95-2008-supplement.zip and unzip to a directory named ismip_all.  The ismip_all directory must be in the directory from which you are running this script.'
      else:
