...
!JEFF commenting out during the first pass through.  There's several direct model references and file writes in glide_write_diag.
     ...
     ! Redistribute calls here to spread the data back out.
     call parallel_halo(model%velocity_hom%efvs)
     call parallel_halo(model%velocity_hom%uvel)
     call parallel_halo(model%velocity_hom%vvel)
     call parallel_halo(model%velocity_hom%uflx)
     call parallel_halo(model%velocity_hom%vflx)
     call parallel_halo(model%velocity_hom%velnorm)
     ...
     call parallel_halo(model%velocity_hom%tau%xx)
     call parallel_halo(model%velocity_hom%tau%yy)
     call parallel_halo(model%velocity_hom%tau%xy)
     call parallel_halo(model%velocity_hom%tau%scalar)
     call parallel_halo(model%velocity_hom%tau%xz)
     call parallel_halo(model%velocity_hom%tau%yz)
     ...
     call parallel_halo(model%velocity%tau_x)
     call parallel_halo(model%velocity%tau_y)
