...
set(hl2,'MarkerSize',ms,'LineStyle','-','Color','r');
set(hl2b,'MarkerSize',ms,'LineStyle','.','Color','r');

set(hl3,'MarkerSize',ms,'LineStyle','-','Color','b');
...
set(ax1,'xlim',[-5 170]);
set(ax2,'xlim',[-5 170]);
set(ax1,'ylim',[-15 50]/100);
set(ax2,'ylim',[25 100]/100);
%set(ax1,'YTick',(-5:5:30)/100);
%set(ax2,'YTick',(60:5:100)/100);

xlabel('time (years)','FontSize',fs);
set(get(ax1,'Ylabel'),'String','rate of volume change (relative to 12 km^3/year influx)','FontSize',fs)
set(get(ax2,'Ylabel'),'String','integrated melt rate (relative to 12 km^3/year influx)','FontSize',fs)
