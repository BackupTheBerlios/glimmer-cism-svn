...
uvelbc   = nc.createVariable('uvelbc',  'f',('time','level','y0','x0'))
vvelbc   = nc.createVariable('vvelbc',  'f',('time','level','y0','x0'))
#temp      = nc.createVariable('temp',  'f',('time','level','y1','x1'))
#bwat     = nc.createVariable('bwat',   'f',('time','y1','x1'))

#Read the data:
d = loadmat('advection.mat')
...
uvelbc[0,:,:,:] = array(d['uvelbc'],dtype='float32')
vvelbc[0,:,:,:] = array(d['vvelbc'],dtype='float32')
