program simple
    ! RN_20091118: The following is a simple unit test that shows how to
    ! interface with Trilinos solvers.
    use sparse_type
    implicit none

    integer :: i, nmax, mtxsize, nnz, bandwidth
    integer :: rowInd, colInd
    double precision, target :: entry
...
!60  enddo
    ...
    ! Initialize the system before making calls to Trilinos routines
    bandwidth = 5 ! approximately number of entries per row
