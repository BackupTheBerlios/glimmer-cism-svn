...
# File to generate input netcdf file that is readable by CISM
# For coupling of ice sheet and basal processes model 
#
# Sytnax: 
# ./python_file_name.py input_file.config
#
...
minTauf = glimcdf.setup_variable(nc, "minTauf", staggered=True)
