module plume_functions
  ...
  private
  public :: rho_func_linear, rho_func_nonlinear,tinsitu_func,freezing_temp_func

contains

  elemental real(kind=kdp) function freezing_temp_func(s,dep)
  ...
  end function freezing_temp_func
  ...
  !*********************************************************************
  !*********************************************************************
  elemental real(kind=kdp) function rho_func_linear(t,s) 
  ...
  !*********************************************************************
  !*********************************************************************
  elemental real(kind=kdp) function rho_func_nonlinear(t,s,p) 
  ...
  end function rho_func_nonlinear
  ...
  elemental real(kind=kdp) function tinsitu_func(tp,s,pin)  
    ...
    integer :: it
    real(kind=kdp),intent(in) :: pin,s,tp
  ...
  end function tinsitu_func

end module plume_functions
